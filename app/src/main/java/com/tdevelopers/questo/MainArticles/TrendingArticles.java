 ...
 */
public class TrendingArticles extends Fragment {
    ...
    public static TrendingArticles newInstance() {

        Bundle args = new Bundle();
        TrendingArticles fragment = new TrendingArticles();
                                                            ...
                                                            if (a != null && !flag) {
                                                                ...
                                                                Collections.sort(dataList, new Comparator<Article>() {
                                                                    ...
                                                                    public int compare(Article s1, Article s2) {
                                                                        ...
                                                                        return (int) (s1.views_count - s2.views_count);
                                                                    }
                                                                });
                                                            }
    ...
    public static void LoadData() {
        notfound.setVisibility(View.GONE);
        final Query q = FirebaseDatabase.getInstance().getReference("Article").orderByChild("views_count").limitToFirst(10);
                    ...
                    if (dataSnapshot != null && dataSnapshot.getValue() != null && dataSnapshot.getChildren() != null) {
                        ...
                        recyclerView.addOnScrollListener(new EndlessRecyclerViewScrollListener(l) {
                            ...
                            public void onLoadMore(int page, int totalItemsCount) {
                                final Query extra = FirebaseDatabase.getInstance().getReference("Article").orderByChild("views_count").limitToFirst(totalItemsCount + 5);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_trending_articles, container, false);
    }
