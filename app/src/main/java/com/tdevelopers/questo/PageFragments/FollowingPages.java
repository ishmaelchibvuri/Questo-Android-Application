 ...
 */
public class FollowingPages extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_following_pages, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = (RecyclerView) view.findViewById(R.id.pagesfollowingrv);
    ...
    public void getData() {
        try {
            ...
            if (Profile.getCurrentProfile() != null)
                FirebaseDatabase.getInstance().getReference("myUsers").child(Profile.getCurrentProfile().getId()).child("pagesfollowing").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
    ...
    public static FollowingPages newInstance() {

        Bundle args = new Bundle();

        FollowingPages fragment = new FollowingPages();
