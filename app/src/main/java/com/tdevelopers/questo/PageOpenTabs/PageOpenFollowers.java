 ...
 */
public class PageOpenFollowers extends Fragment {
    ...
    public PageOpenFollowers(String id) {
        // Required empty public constructor
        this.id = id;
    }

    public PageOpenFollowers() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_page_open_followers, container, false);
    }

    public static PageOpenFollowers newInstance(String id) {

        Bundle args = new Bundle();

        PageOpenFollowers fragment = new PageOpenFollowers(id);
    ...
    public void getData() {
        ...
        try {
            ...
            if (id != null && id.trim().length() != 0) {
                ...
                Query query = FirebaseDatabase.getInstance().getReference("PageFollowers").child(id + "");
