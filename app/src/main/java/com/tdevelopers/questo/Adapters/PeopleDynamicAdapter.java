...
public class PeopleDynamicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public PeopleDynamicAdapter(ArrayList<user> data) {
        this.data = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ME) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.message_people_me, parent, false);
            context = view.getContext();
            return new ME_PeopleViewHolder(view);
        } else {


            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.message_people, parent, false);
            context = view.getContext();
...
//                holder.subtext.setText(t.followers.size() + " followers | " + t.following.size() + " following");
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent = new Intent(v.getContext(), ChatOpenActivity.class);
