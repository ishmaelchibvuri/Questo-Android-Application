...
public class MostLiked extends Fragment {
                                                            ...
                                                            if (a != null && !flag) {
                                                                ...
                                                                Collections.sort(dataList, new Comparator<Question>() {
                                                                    ...
                                                                    public int compare(Question s1, Question s2) {
                                                                        ...
                                                                        return (int) (s1.likes_count - s2.likes_count);
                                                                    }
                                                                });
                                                            }
    ...
    public static void LoadData() {
        notfound.setVisibility(View.GONE);
        final Query q = FirebaseDatabase.getInstance().getReference("Question").orderByChild("likes_count").limitToFirst(10);
                    ...
                    if (dataSnapshot != null && dataSnapshot.getValue() != null && dataSnapshot.getChildren() != null) {
                        ...
                        recyclerView.addOnScrollListener(new EndlessRecyclerViewScrollListener(l) {
                            ...
                            public void onLoadMore(int page, int totalItemsCount) {
                                final Query extra = FirebaseDatabase.getInstance().getReference("Question").orderByChild("likes_count").limitToFirst(totalItemsCount + 5);
